...
<title>Delete beneficiary Successful</title>
...
<body>
	<div class="menu">
		...
		<div class="bodywithoutSide">
				<h3><u>Notice</u></h3>
				<p> You have successfully deleted the beneficiary </p>
				<div class="buttonCol5">
					<a href="manageBeneficiary.jsp"><button> Return to main page </button></a>
				</div>
		</div>
